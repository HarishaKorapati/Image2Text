...
if __name__ == "__main__":
    with open('/content/drive/MyDrive/ISE_Final/flickr8k/cleaned_captions.pkl', 'rb') as f:
    ...
    train_images = []
    with open('/content/drive/MyDrive/ISE_Final/flickr8k/Flickr_8k.trainImages.txt', 'r') as f:
        for line in f:
    ...
    # Save train captions
    with open('/content/drive/MyDrive/ISE_Final/flickr8k/train_captions.pkl', 'wb') as f:
        joblib.dump(train_captions, f, compress=3)

    # Save vocabulary
    train_words = filter_by_count(train_captions)
    vocabulary = to_vocabulary(train_words)
    with open('/content/drive/MyDrive/ISE_Final/flickr8k/vocabulary.txt', 'w') as f:
